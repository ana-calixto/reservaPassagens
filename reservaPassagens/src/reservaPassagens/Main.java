...
public class Main {
	static Aviao a;
	static Voo[] v = new Voo[10]; 
	static int numeroDeVoos = 0; 
			...
			try {
				...
				do {
					...
					case 2:
						...
						if(numeroDeVoos == 10) {
							JOptionPane.showMessageDialog(null,"Já atingiu o numero máximo de voos");
							break;
						}
						...
						//HoraDoVoo
						String horaVoo = JOptionPane.showInputDialog(null, "Digite o horario do Voo: ");
			...
			try {
				do {
					...
					case 1:
						...
						if(v[0] == null) {
							JOptionPane.showMessageDialog(null, "Favor cadastrar um vôo!");
							break;
						}
						...
						if(aeronave.verificarSeExisteLugaresDisponiveis()) {
							...
							if (aeronave.verificaLugarOcupado( Integer.parseInt(fileira), Integer.parseInt(assento))) {
									JOptionPane.showMessageDialog(null, "Assento ocupado, favor informar outro assento");
							...
							JOptionPane.showMessageDialog(null, "Não existem mais lugares disponiveis nesse voo");
						}
